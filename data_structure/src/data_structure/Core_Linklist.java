...
//		link.first = reverserecurion(first);
//		link.values();
		reverserecurion(first);
	}
	 void reverserecurion(Node cur)
	 {
		// MyLinklist link=new MyLinklist();
		...
		reverserecurion(cur.getNext());
////		Node temp=new Node(cur.getValue());
////		temp.setNext(temp);
////		return temp;
//		Node head=new Node(cur.getValue());
//		//head.setNext(new Node(cur.getValue()));
//		
//		//return head;
//		 if(head==null)
//		 {
////		 System.out.println("1");
////		head=new Node(cur.getValue());
//		 }
//		 else
//		 {
